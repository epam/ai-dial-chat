...
| [`docs/observability.md`](../../../docs/observability.md)                                                       | Configuring OpenTelemetry, interpreting HTTP/generation/runtime metrics, importing Grafana dashboards, or troubleshooting missing telemetry.                   |
| [`docs/host-install-matrix.md`](../../../docs/host-install-matrix.md)                                           | An embedding host asks what to put in its own `package.json` for a given set of libs. Generated from the manifests; do not hand-edit.                          |
