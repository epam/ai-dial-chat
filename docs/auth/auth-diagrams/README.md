...
| [`10-offline-credentials-consent.mmd`](./10-offline-credentials-consent.mmd) | Proactive Scheduled Tasks offline-credentials consent (list-page entry -> status check -> banner -> popup -> authoritative refetch) |
