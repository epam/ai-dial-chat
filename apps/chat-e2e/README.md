...
| `SANDBOX_OVERLAY_HOST`                    | No       | Overlay domain host                                                                                                                                                            | Any string                                                 | <http://localhost:3000> |
...
| `AUTH_AUTH0_CLIENT_ID`                    | No       | Auth0 client ID for debug authentication                                                                                                                                       | Any string                                                 |                         |
| `AUTH_AUTH0_SECRET`                       | No       | Auth0 client secret for debug authentication                                                                                                                                   | Any string                                                 |                         |
| `AUTH_AUTH0_HOST`                         | No       | Auth0 host for debug authentication                                                                                                                                            | Any string                                                 |                         |
| `AUTH_AUTH0_AUDIENCE`                     | No       | Auth0 audience for debug authentication                                                                                                                                        | Any string                                                 |                         |
| `AUTH_CONNECTION`                         | No       | Auth0 connection for debug authentication                                                                                                                                      | Any string                                                 |                         |
| `AUTH_TENANT`                             | No       | Auth0 tenant for debug authentication                                                                                                                                          | Any string                                                 |                         |
| `AUTH0_INTSTATE`                          | No       | Auth0 intstate for debug authentication                                                                                                                                        | Any string                                                 |                         |
| `AUTH_HOST`                               | No       | Fallback for `AUTH_AUTH0_HOST`                                                                                                                                                 | Any string                                                 |                         |
| `AUTH_CLIENT_ID`                          | No       | Fallback for `AUTH_AUTH0_CLIENT_ID`                                                                                                                                            | Any string                                                 |                         |
| `AUTH_CALLBACK_URL_OVERRIDE`              | No       | Auth0 callback URL override for debug authentication                                                                                                                           | Any string                                                 |                         |
