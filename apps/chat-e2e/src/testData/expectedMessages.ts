export enum ExpectedMessages {
  ...
  contextMenuOptionIsVisible = 'Context menu option is visible',
  ...
  sendMessageInputIsAvailable = 'Send message input is available',
  ...
  leavePlaybackButtonAvailable = 'Leave Playback button available',
  leavePlaybackButtonIsNotAvailable = 'Leave Playback button is not available',
  ...
  chatHeaderIsNotVisible = 'Chat header is not visible',
  conversationSettingsVisible = 'Conversation Settings screen is visible',
  conversationSettingsNotVisible = 'Conversation Settings screen is not visible',
  ...
  messageRageIsValid = 'Message rate is valid',
  chatIconIsJumping = 'Chat icon is jumping',
  iconIsVisible = 'Icon is visible',
  chatMessagesAreVisible = 'Chat messages are visible',
  isolatedViewIsOpened = 'Isolated view is opened',
  footerIsVisible = 'Footer is visible',
  attachmentIconIsVisible = 'Attachment icon is visible',
}
