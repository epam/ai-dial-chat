...
export const ExpectedMessages = {
  ...
  chatInfoResponseFormatIsValid: 'Chat info response format is valid',
  chatInfoCompactModeIsValid: 'Chat info compact mode is valid',
  ...
  requestResponseFormatIsValid:
    'Request responseFormat is valid in conversation API request',
  ...
  tableIsHidden: 'Table is not visible in chat message',
  ...
  tableDownloadIconIsVisible: 'Table Download icon is available',
  ...
  elementTextAlignmentIsValid: 'Element text alignment is valid',
  ...
  spacingIsReduced: 'Spacing is reduced in compact mode',
