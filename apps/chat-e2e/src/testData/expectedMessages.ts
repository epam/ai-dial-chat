...
export const MarketplaceExpectedMessages = {
  ...
  toolsetOAuthRedirectStateIsDefined: 'Toolset OAuth redirect request state is defined',
  toolsetOAuthRedirectResponseTypeIsValid: 'Toolset OAuth redirect request response type is valid',
  toolsetOAuthRedirectCodeChallengeMethodIsValid: 'Toolset OAuth redirect request code challenge method is valid',
  toolsetOAuthRedirectClientIdIsValid: 'Toolset OAuth redirect request client id is valid',
  ...
  toolsetSignInAuthTypeIsValid: 'Toolset Sign-in request authentication type is valid',
  toolsetSignInCredentialsLevelIsValid: 'Toolset Sign-in request credentials level is valid',
  ...
  toolsetSignOutAuthTypeIsValid: 'Toolset Sign-out request authentication type is valid',
  toolsetSignOutCredentialsLevelIsValid: 'Toolset Sign-out request credentials level is valid',
};
