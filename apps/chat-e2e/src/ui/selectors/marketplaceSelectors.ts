...
export const MarketplaceDetailsModal = {
  ...
  sectionContainer: '[data-qa="section-root"]',
  limitsGrid: '[data-qa="limits-grid"]',
  limitItem: '[data-qa="limit-item"]',
  limitKey: '[data-qa="limit-key"]',
  usedLimit: '[data-qa="used-limit"]',
  totalLimit: '[data-qa="total-limit"]',
  usageContainer: '[data-qa="usage-container"]',
  usageProgress: '[data-qa="usage-progress"]',
  noLimits: '[data-qa="no-limits"]',
  viewButton: 'View',
