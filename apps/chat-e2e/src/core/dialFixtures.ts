...
const dialTest = test.extend<{
  ...
  organizationFolderPrompts: FolderPrompts;organizationConversations: OrganizationConversationsTree;
  organizationPrompts: OrganizationPromptsTree;organizationFolderConversations: Folders;
  ...
  renameConversationModal: RenameConversationModal;
    renameConversationModalAssertion: RenameConversationModalAssertion;variableModalDialog: VariableModalDialog;
  ...
  promptsToPublishTree: PromptsToPublishTree;folderConversationsToPublish: FolderConversationsToPublish;
  ...
  organizationConversationAssertion: SideBarEntityAssertion<OrganizationConversationsTree>;organizationPromptAssertion: SideBarEntityAssertion<OrganizationPromptsTree>;
  ...
  promptBarOrganizationFolderAssertion: FolderAssertion<FolderPrompts>;promptAssertion: PromptAssertion;
  ...
  conversationToPublishAssertion: ConversationToPublishAssertion;promptToPublishAssertion: PromptToPublishAssertion;
