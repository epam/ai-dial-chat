...
| `HALLOWEEN_ENABLED`                     | `false`                        | Enables Halloween only on the start page (`/`): seasonal replacement of the existing navigation/header icon, corner spiders, and a large candlelit pumpkin that chuckles visually on hover/focus. Pumpkin clicks randomly choose ghosts, a connected web woven by many tiny spiders, bats, a cat with wisps, or flying witches, without consecutive repeats. Every celebration notification reveals the secret chat phrase. Sending "trick or treat" from the start-page composer drops spiders instead of creating a conversation. Existing chats and editor previews send it normally. Effects clear on navigation, persist no data, play no sound, and respect reduced motion. Takes effect on the next service restart.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
