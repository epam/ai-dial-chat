...
| `SKILL_FILE_UPLOAD_MAX_BYTES`           | `1048576`                      | Maximum size (bytes) of a single file in a whole-skill create/update or via `PUT /api/v1/skills/files` (default 1 MB); rejected with 413                                                                                                                                                                                                                                                                                                                                                                                                                                            |
