...
Before starting apps, need to specify the `SANDBOX_OVERLAY_HOST` env variable that refers to the DIAL chat host launched in overlay mode and the `SANDBOX_OVERLAY_USER_BUCKET` variable that corresponds to the user bucket suppose to use the sandbox.
