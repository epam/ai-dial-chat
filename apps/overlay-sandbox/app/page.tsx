...
enum OverlayCases {
  ...
  fullWidthMdBreakpointSandbox = '/cases/overlay/full-width-md-breakpoint-sandbox',
  fullWidthDefaultBreakpointSandbox = '/cases/overlay/full-width-default-breakpoint-sandbox',
