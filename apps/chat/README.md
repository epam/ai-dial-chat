...
| `DIAL_API_KEY`                      | Yes                             | AI DIAL Core API Key.<br />Refer to [AI DIAL Core](https://github.com/epam/ai-dial-core?tab=readme-ov-file#dynamic-settings).                                                                                                                                                                                                                                                                                  | Any string                                                             |                                    |
...
| `THEMES_CONFIG_HOST`                | No                              | The host URL for a custom themes configuration.<br />Refer to [Theme Customization](docs/THEME-CUSTOMIZATION.md) to learn more.                                                                                                                                                                | Any string                                                             |                                    |
