  ...
  reducers: {
    ...
    updateModel: (
      ...
      const newModel: DialAIEntityModel = {
        sharedWithMe: state.modelsMap[payload.model.reference]?.sharedWithMe,
        permissions: state.modelsMap[payload.model.reference]?.permissions,
        ...payload.model,
      };
...
const selectModelById = createSelector(
