    ...
    switchMap(({ payload }) =>
      zip(
        payload.paths.map((path) =>
          ConversationService.getConversationsAndFolders(
            path,
              ...
              concat(
                ...
                of(
                  UIActions.setOpenedFoldersIds({
                    ...
                    openedFolderIds: [
                      ...paths,
                      ...(payload.paths.filter(Boolean) as string[]),
                    ],
                  }),
                ),
                of(
