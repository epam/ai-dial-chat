...
/**
 * The 23 `OverlayFeature` keys enabled by default, reflecting today's
 ...
 * (17 "modifier" keys) defaults off so a deployment that configures nothing
