...
export enum CommonI18nKeys {
  ...
  Icon = 'Icon',
  NoIcon = 'No icon',
  SelectApplicationIcon = 'Select application icon',
  SelectToolsetIcon = 'Select toolset icon',
  Cancel = 'Cancel',
  Confirm = 'Confirm',
  Unshare = 'Unshare',
  Delete = 'Delete',
  ...
  TopicUserExperience = 'User Experience',
  TopicAnalysis = 'Analysis',
  TopicSQL = 'SQL',
  TopicSDLC = 'SDLC',
  TopicTalkToYourData = 'Talk-To-Your-Data',
  TopicRAG = 'RAG',
  TopicTextGeneration = 'Text Generation',
  TopicImageGeneration = 'Image Generation',
  TopicImageRecognition = 'Image Recognition',
  ...
  TokenEndpointAuthMethodBasic = 'Client secret (HTTP Basic)',
  TokenEndpointAuthMethodPost = 'Client secret (POST body)',
...
export enum ErrorsI18nKeys {
  ...
  NameIsTooLong = 'The {{name}} is too long. Please shorten it and try again.',
  DotAtStartOfNameNotPermitted = 'Using a dot at the start of a {{name}} is not permitted.',
  VersionIsRequired = 'Version is required',
  VersionFormatInvalid = 'Version format is invalid (example: 0.0.1)',
  VersionAlreadyExists = 'This version already exists',
  VersionPartTooLong = 'Each part of the version should contain no more than five numbers.',
}
...
export enum SideBarI18nKeys {
  ...
  Equals = 'Equals',
  Regex = 'Regex',
  PublicationFilterTitle = 'Title',
  PublicationFilterJobTitle = 'Job Title',
  PublicationFilterRole = 'Role',
  PublicationFilterDialRoles = 'Dial Roles',
  ...
  ItemsQuestion = 'items?',
  DeletingWillStopSharingFile = '\nDeleting will stop sharing and other users will no longer see this item.',
  DeletingWillStopSharingItems = '\nDeleting will stop sharing and other users will no longer see these items.',
  ...
  ReplaceOrDuplicateItem = 'Replace Or Duplicate Item',
  ReplaceOrDuplicateItems = 'Replace Or Duplicate Items',
  FileConflictReplace = 'Replace',
  ReplaceAll = 'Replace all',
  DuplicateAll = 'Duplicate all',
  DecideForEach = 'Decide for each',
  FileConflictItemExistsPrefix = 'Item with the name ',
  FileConflictItemExistsSuffix = 'already exists in this destination.',
  FileConflictMultipleItemsExists = '{{count}} items with the same names already exist in this destination.',
  ActionColumn = 'Action',
}
...
export enum ChatI18nKeys {
  ...
  TooManyFilesDescriptionSingular = 'You selected {{count}} files, including previously attached ones. You can attach up to {{limit}} file.',
  ...
  UpToFilesSingular = 'Up to {{maxAttachmentsAmount}} file.',
  all = 'all',
  ProcessingFiles = 'Processing files...',
  ...
  ReduceSpacingWithinMessages = 'Reduce spacing within messages',
  CompactModeHint = 'Proportionally reduce spacing and line gaps within message content to fit more on the screen.',
  YouDontHaveAnyFiles = "You don't have any files",
