...
export enum SkillEditorI18nKeys {
  ...
  AddLabel = 'skillEditor.addLabel',
  AddFileLabel = 'skillEditor.addFileLabel',
  AddFolderLabel = 'skillEditor.addFolderLabel',
  AddUploadLabel = 'skillEditor.addUploadLabel',
  NewPathLabel = 'skillEditor.newPathLabel',
  NewPathPlaceholder = 'skillEditor.newPathPlaceholder',
  ...
  ErrorTooManyFiles = 'skillEditor.error.tooManyFiles',
  ErrorServiceUnavailable = 'skillEditor.error.serviceUnavailable',
  ErrorArchiveBuildFailed = 'skillEditor.error.archiveBuildFailed',
