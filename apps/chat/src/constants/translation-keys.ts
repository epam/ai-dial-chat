...
export enum ConversationI18nKeys {
  ...
  ToolStageWebSearch = 'conversation.stages.toolStage.webSearch',
  ReasoningSummaryTitle = 'conversation.reasoningSummary.title',
  ReasoningSummaryExpandAriaLabel = 'conversation.reasoningSummary.expandAriaLabel',
  ReasoningSummaryCollapseAriaLabel = 'conversation.reasoningSummary.collapseAriaLabel',
