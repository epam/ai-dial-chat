...
export enum UsageI18nKeys {
  ...
  PeriodSelectorAriaLabel = 'usage.periodSelectorAriaLabel',
  ItemColumnLabel = 'usage.itemColumnLabel',
  CostColumnLabel = 'usage.costColumnLabel',
  TokensColumnLabel = 'usage.tokensColumnLabel',
  RequestsColumnLabel = 'usage.requestsColumnLabel',
  StatusColumnLabel = 'usage.statusColumnLabel',
  ModelTypeLabel = 'usage.modelTypeLabel',
  PeriodLastMinuteLabel = 'usage.periodLastMinuteLabel',
  PeriodLastHourLabel = 'usage.periodLastHourLabel',
