...
export enum CatalogI18nKeys {
  ...
  DetailsSkillSpecificationSection = 'catalog.details.skill.specificationSection',
  DetailsSkillWhenToUse = 'catalog.details.skill.whenToUse',
  DetailsSkillAllowedTools = 'catalog.details.skill.allowedTools',
  DetailsSkillBundledResources = 'catalog.details.skill.bundledResources',
  DetailsContentFileSelectorAriaLabel = 'catalog.details.contentFileSelectorAriaLabel',
  DetailsContentFileCount = 'catalog.details.contentFileCount',
  ...
  CredentialsManageApiKeysLabel = 'catalog.details.credentials.manageApiKeysLabel',
  CredentialsChangeApiKeyActionLabel = 'catalog.details.credentials.changeApiKeyActionLabel',
  CredentialsPersonalApiKeyPanelTitle = 'catalog.details.credentials.personalApiKeyPanelTitle',
  CredentialsPersonalApiKeyAddedMessage = 'catalog.details.credentials.personalApiKeyAddedMessage',
  CredentialsApiKeyConfiguredMessage = 'catalog.details.credentials.apiKeyConfiguredMessage',
  ...
  CredentialsOrgFallbackBannerTitleApiKey = 'catalog.details.credentials.orgFallbackBannerTitleApiKey',
  CredentialsOrgFallbackBannerDescriptionCredentials = 'catalog.details.credentials.orgFallbackBannerDescriptionCredentials',
  CredentialsOrgFallbackBannerDescriptionApiKey = 'catalog.details.credentials.orgFallbackBannerDescriptionApiKey',
  CredentialsOrgActiveBannerTitleCredentials = 'catalog.details.credentials.orgActiveBannerTitleCredentials',
  CredentialsOrgActiveBannerTitleApiKey = 'catalog.details.credentials.orgActiveBannerTitleApiKey',
  CredentialsPersonalActiveBannerTitleCredentials = 'catalog.details.credentials.personalActiveBannerTitleCredentials',
  CredentialsPersonalActiveBannerTitleApiKey = 'catalog.details.credentials.personalActiveBannerTitleApiKey',
  CredentialsManagementTitleCredentials = 'catalog.details.credentials.managementTitleCredentials',
  CredentialsManagementTitleApiKey = 'catalog.details.credentials.managementTitleApiKey',
  CredentialsManagementDescriptionCredentials = 'catalog.details.credentials.managementDescriptionCredentials',
  CredentialsManagementDescriptionApiKey = 'catalog.details.credentials.managementDescriptionApiKey',
  CredentialsPersonalLabel = 'catalog.details.credentials.personalLabel',
  CredentialsPersonalDescription = 'catalog.details.credentials.personalDescription',
  CredentialsOrganizationLabel = 'catalog.details.credentials.organizationLabel',
  CredentialsOrganizationDescription = 'catalog.details.credentials.organizationDescription',
  ...
  CredentialsApiKeyAddedSuccessTitle = 'catalog.details.credentials.apiKeyAddedSuccessTitle',
  CredentialsApiKeyAddedSuccessOrg = 'catalog.details.credentials.apiKeyAddedSuccessOrg',
  CredentialsApiKeyAddedSuccessGlobal = 'catalog.details.credentials.apiKeyAddedSuccessGlobal',
  CredentialsApiKeyAddedSuccessUser = 'catalog.details.credentials.apiKeyAddedSuccessUser',
  CredentialsApiKeyDeletedSuccessTitle = 'catalog.details.credentials.apiKeyDeletedSuccessTitle',
  CredentialsApiKeyDeletedSuccessOrg = 'catalog.details.credentials.apiKeyDeletedSuccessOrg',
  CredentialsApiKeyDeletedSuccessGlobal = 'catalog.details.credentials.apiKeyDeletedSuccessGlobal',
  CredentialsApiKeyDeletedSuccessUser = 'catalog.details.credentials.apiKeyDeletedSuccessUser',
  ...
  DetailsUnpublishConfirmTitle = 'catalog.details.unpublish.confirmTitle',
  DetailsUnpublishConfirmMessage = 'catalog.details.unpublish.confirmMessage',
  DetailsUnpublishSelectFolderMessage = 'catalog.details.unpublish.selectFolderMessage',
  DetailsUnpublishFolderGroupAriaLabel = 'catalog.details.unpublish.folderGroupAriaLabel',
  DetailsUnpublishConsequenceEveryoneLosesAccess = 'catalog.details.unpublish.consequenceEveryoneLosesAccess',
  DetailsUnpublishConsequenceKeepsYourCopy = 'catalog.details.unpublish.consequenceKeepsYourCopy',
  DetailsUnpublishConsequenceCanPublishAgain = 'catalog.details.unpublish.consequenceCanPublishAgain',
  DetailsUnpublishRequestingStatus = 'catalog.details.unpublish.requestingStatus',
...
/** Keys for the conversation unpublish confirmation popup. */
export enum ConversationUnpublishI18nKeys {
  ConfirmTitle = 'conversationUnpublish.confirmTitle',
  ConfirmMessage = 'conversationUnpublish.confirmMessage',
  SelectFolderMessage = 'conversationUnpublish.selectFolderMessage',
  FolderGroupAriaLabel = 'conversationUnpublish.folderGroupAriaLabel',
  RequestingStatus = 'conversationUnpublish.requestingStatus',
}
...
export enum PublishAccessRulesI18nKeys {
  ...
  TargetsHintLabel = 'publishAccessRules.targetsHintLabel',
  RequiredFieldError = 'publishAccessRules.requiredFieldError',
  TargetsRequiredError = 'publishAccessRules.targetsRequiredError',
...
export enum AppsEditorI18nKeys {
  ...
  GeneralFormThemeUrlLabel = 'appsEditor.generalForm.themeUrlLabel',
  GeneralFormThemeUrlPlaceholder = 'appsEditor.generalForm.themeUrlPlaceholder',
  GeneralFormThemeUrlCaption = 'appsEditor.generalForm.themeUrlCaption',
  GeneralFormThemeUrlInvalid = 'appsEditor.generalForm.themeUrlInvalid',
...
export enum ToolsetEditorI18nKeys {
  ...
  ShowApiKeyLabel = 'toolsetEditor.auth.showApiKeyLabel',
  HideApiKeyLabel = 'toolsetEditor.auth.hideApiKeyLabel',
  ...
  ShowClientSecretLabel = 'toolsetEditor.auth.showClientSecretLabel',
  HideClientSecretLabel = 'toolsetEditor.auth.hideClientSecretLabel',
...
export enum EntityNotificationsI18nKeys {
  ...
  PromptUnpublishRequestedTitle = 'entityNotifications.prompt.unpublishRequestedTitle',
  PromptUnpublishRequested = 'entityNotifications.prompt.unpublishRequested',
  ...
  AgentUnpublishRequestedTitle = 'entityNotifications.agent.unpublishRequestedTitle',
  AgentUnpublishRequested = 'entityNotifications.agent.unpublishRequested',
  ...
  QuickAppUnpublishRequestedTitle = 'entityNotifications.quickApp.unpublishRequestedTitle',
  QuickAppUnpublishRequested = 'entityNotifications.quickApp.unpublishRequested',
  ...
  CustomAppUnpublishRequestedTitle = 'entityNotifications.customApp.unpublishRequestedTitle',
  CustomAppUnpublishRequested = 'entityNotifications.customApp.unpublishRequested',
  ...
  ToolsetUnpublishRequestedTitle = 'entityNotifications.toolset.unpublishRequestedTitle',
  ToolsetUnpublishRequested = 'entityNotifications.toolset.unpublishRequested',
  ...
  ModelUnpublishRequestedTitle = 'entityNotifications.model.unpublishRequestedTitle',
  ModelUnpublishRequested = 'entityNotifications.model.unpublishRequested',
  ...
  SkillDownloaded = 'entityNotifications.skill.downloaded',
  ...
  SkillUnpublishRequestedTitle = 'entityNotifications.skill.unpublishRequestedTitle',
  SkillUnpublishRequested = 'entityNotifications.skill.unpublishRequested',
  ...
  ConversationUnpublishRequestedTitle = 'entityNotifications.conversation.unpublishRequestedTitle',
  ConversationUnpublishRequested = 'entityNotifications.conversation.unpublishRequested',
...
export enum UsageI18nKeys {
  ...
  ItemColumnLabel = 'usage.itemColumnLabel',
  CostColumnLabel = 'usage.costColumnLabel',
