...
export const getCommonPageProps: GetServerSideProps = async ({
  ...
  const settings: SettingsState = {
    ...
    topics: (process.env.TOPICS ?? 'Business,Development,User Experience,Analysis,SQL,SDLC,Talk-To-Your-Data,RAG,Text Generation,Image Generation,Image Recognition').split(',')
  };
