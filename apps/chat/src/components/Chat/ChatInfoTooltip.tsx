...
const getModelTemplate = (
  ...
  <>
    <span className="text-secondary-bg-dark">{label}:</span>
    <div
...
export const ChatInfoTooltip = ({
  ...
  return (
    ...
    >
      ...
      {prompt && (
        <>
          <span className="text-secondary-bg-dark">{t('System prompt')}:</span>
          <div
      ...
      {temperature !== null && (
        <>
          <span className="text-secondary-bg-dark">{t('Temperature')}:</span>
          <div data-qa="temp-info">{temperature}</div>
        </>
      )}
      {selectedAddons !== null && selectedAddons?.length > 0 && (
        <>
          <span className="text-secondary-bg-dark">{t('Addons')}:</span>
