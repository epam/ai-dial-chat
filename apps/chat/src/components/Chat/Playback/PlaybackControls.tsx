    ...
    <div ref={controlsContainerRef} className="w-full pt-3 md:pt-5">
      ...
      >
        <button
          ...
          className="absolute bottom-3 left-4 rounded outline-none text-quaternary-bg-light hover:text-primary-bg-light disabled:cursor-not-allowed disabled:text-controls-disable"
        >
              ...
              {activeMessage && (
                <>
                  ...
                  <button
                    ...
                    className="absolute bottom-3 right-4 rounded outline-none text-quaternary-bg-light hover:text-primary-bg-light disabled:cursor-not-allowed disabled:text-controls-disable"
