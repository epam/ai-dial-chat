...
vi.mock('@/src/components/VisualalizerRenderer/VisualizerRenderer', () => ({
  VisualizerRenderer: () => <div data-qa="visualizer-renderer">Visualizer Content</div>,
}));
...
vi.mock('@/src/store/selectors', () => ({
  ...
  SettingsSelectors: {
    selectMappedVisualizers: () => ({
      'application/vnd.custom': [{ title: 'Custom Visualizer', url: 'http://localhost:3000' }],
    }),
...
vi.mock('@/src/components/Plotly/PlotlyStringDataRenderer', () => ({
  PlotlyStringDataRenderer: () => <div data-qa="plotly-string-renderer">Plotly String Content</div>,
}));
