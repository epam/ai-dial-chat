  ...
  return (
    <>
      <div className="flex size-[60px] items-center justify-center">
        ...
        >
          <button
            className="flex size-[44px] items-center justify-center rounded-full border border-transparent hover:bg-control-accent-alpha-hover focus-visible:outline focus-visible:-outline-offset-1 focus-visible:outline-focus"
