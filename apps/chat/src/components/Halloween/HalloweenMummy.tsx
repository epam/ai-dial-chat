...
const HalloweenMummy: FC = () => {
  ...
  useEffect(() => {
    ...
    /* The composer is a lazy library; resolve its public selector at the same boundary. */
    void import('@epam/ai-dial-conversation-input')
      .then(({ CONVERSATION_INPUT_CLASS }) => {
        if (disposed) return;
        setReady(true);
  ...
  return (
    <div
      ...
      data-halloween-scene={HalloweenBurst.Mummy}
