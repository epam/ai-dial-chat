...
const Tooltip: FC<TooltipRenderProps> = ({
  ...
  return (
    <div
      ...
      className="h-[165px] w-[320px] rounded-md bg-[#023465] text-xs text-[#BAD9FF]"
    >
      ...
      <div className="relative bottom-[-16px] flex h-[35px] w-[320px] items-center justify-between rounded-b-md bg-gradient-to-r from-[#C0DDF2] to-[#F3E8CE] px-4 text-[#023465]">
        {index > 1 ? (
          <button
