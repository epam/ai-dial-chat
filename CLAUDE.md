...
| **Testing** | `/dial-testing` | [`.claude/guides/testing-patterns.md`](.claude/guides/testing-patterns.md) | Writing or fixing unit/e2e tests, setting up mocks or fixtures |
