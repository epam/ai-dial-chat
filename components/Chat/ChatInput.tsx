    ...
    return (
      ...
      >
        <div className="stretch mx-2 mt-4 flex flex-row gap-3 last:mb-2 md:mx-4 md:mt-[52px] md:last:mb-6 lg:mx-auto lg:max-w-3xl">
          ...
          <div
            className="relative mx-2 flex w-full grow flex-col rounded-md border border-black/10 bg-gray-100 shadow-[0_0_10px_rgba(0,0,0,0.10)] dark:border-gray-900/50 dark:bg-gray-700 dark:shadow-[0_0_15px_rgba(0,0,0,0.10)] sm:mx-4"
            data-qa="message"
          >
            <textarea
              ref={textareaRef}
