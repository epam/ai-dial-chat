  ...
  return (
    <>
      <button
        ...
        } z-50 h-7 w-7 hover:text-gray-400 dark:text-white dark:hover:text-gray-300 sm:top-0.5${
          side === 'right' ? 'right-[270px]' : 'left-[270px]'
...
export const OpenSidebarButton = ({ onClick, side }: Props) => {
  return (
    <button
      ...
      } z-50 h-7 w-7 text-white hover:text-gray-400 dark:text-white dark:hover:text-gray-300 sm:top-0.5${
        side === 'right' ? 'right-2' : 'left-2'
      } sm:h-8 sm:w-8 sm:text-neutral-700`}
      onClick={onClick}
    >
