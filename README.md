...
│
├── libs/                        # 29 @epam/* workspace libraries (see Libraries)
...
- Prettier 3.9
- Vitest 4.1
- Storybook 10.6 (`@epam/ai-dial-celebrations` only)
...
| `@epam/ai-dial-celebrations`          | [`libs/celebrations`](libs/celebrations)                   | Seasonal start-page celebrations with lazily loaded Halloween and New Year scenes hosts can switch on and off |
