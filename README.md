...
| `ENABLED_FEATURES`                  | No                              | Enabled Features                                                                                                             | See available features [here](src/types/features.ts) |                  |
...
| `E2E_USERNAME`                      | No                              | A username/password for e2e authentification  | Any string  |                  |
| `E2E_PASSWORD`                      | No                              | A username/password for e2e authentification  | Any string  |                  |
...
| `STORAGE_TYPE`                      | No                              | Type of storage used for getting and saving information generated by user                                                    | `browserStorage`, `api`,`apiMock`                    | `browserStorage` |
