...
/** Ghosts released per `HalloweenScene.Ghost`, each on its own flight path. */
...
export const HALLOWEEN_CLICK_BURSTS = [
  HalloweenScene.Ghost,
  HalloweenScene.Web,
  HalloweenScene.Bats,
  HalloweenScene.Cat,
  HalloweenScene.Witches,
