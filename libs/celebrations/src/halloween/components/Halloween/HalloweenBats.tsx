...
const HalloweenBats: FC = () => {
  ...
  useEffect(() => {
    ...
    const prepare = async () => {
      ...
      setPlan(buildBatPlan(getBatTargets(anchors, isMobile ? 3 : 5), isMobile));
    };
    prepare();
    return () => {
      disposed = true;
  ...
  }, [anchors, changed, isMobile, reducedMotion, stopScene, supportsMotion]);
  ...
  return (
    <div
      ...
      aria-hidden="true"
      inert
      data-halloween-scene={HalloweenScene.Bats}
