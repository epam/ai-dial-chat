...
export const SearchInput: FC<SearchInputProps> = memo(
  ({ placeholder, value, onChange, iconClassName = 'text-secondary' }) => (
    <div className={mergeClasses('border-b px-2 py-1', panelStyles.divider)} data-cp-search-wrapper>
      <div className={mergeClasses('flex h-9 w-full items-center gap-2 ps-3 pe-3', styles.row)}>
        <IconSearch
          size={16}
          stroke={1.5}
        ...
        <input
          ...
          className={mergeClasses('flex-1 bg-transparent outline-none', styles.input)}
        />
        {value && (
          <button
            type="button"
