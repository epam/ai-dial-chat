...
export interface ConversationRowProps {
  ...
  /** CSS class applied to the task pill badge (background, border, and text color). Defaults to `'border-tertiary bg-layer-base text-secondary'`. */
...
export const ConversationRow: FC<ConversationRowProps> = ({
  ...
  taskBadgeClassName = 'border-tertiary bg-layer-base text-secondary',
  rowGroupKey,
  rows,
  draggingId,
  dragOverId,
  ...
  const taskBadge = item.showTaskBadge ? (
    <span
      className={mergeClasses(
        'dial-caption-semi-text flex h-5 shrink-0 items-center justify-center gap-0.5 rounded-full border pe-2 ps-1 uppercase tracking-[0.6px]',
        taskBadgeClassName,
      )}
    >
