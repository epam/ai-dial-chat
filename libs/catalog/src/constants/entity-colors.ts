...
export const ENTITY_TYPE_COLOR: Record<CatalogEntityType, string> = {
  ...
  [CatalogEntityType.Guardrail]: '#BE123C',
  [CatalogEntityType.Mcp]: '#0E7490',
};
...
export const ENTITY_TYPE_SHADOW: Record<CatalogEntityType, string> = {
  ...
  [CatalogEntityType.Application]: 'rgba(5, 150, 105, 0.12)',
  [CatalogEntityType.Agent]: 'rgba(124, 58, 237, 0.12)',
  [CatalogEntityType.Skill]: 'rgba(14, 116, 144, 0.12)',
  [CatalogEntityType.Toolset]: 'rgba(180, 83, 9, 0.12)',
  [CatalogEntityType.Guardrail]: 'rgba(190, 18, 60, 0.12)',
  [CatalogEntityType.Mcp]: 'rgba(14, 116, 144, 0.12)',
};
