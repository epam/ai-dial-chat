  ...
  return (
    <FloatingPortal id="chat">
      <div className="fixed inset-0 top-[48px] z-30 flex items-center justify-center bg-blackout p-3 md:p-5">
        <div
          className="m-auto flex h-full w-full grow flex-col gap-4 divide-tertiary overflow-y-auto rounded bg-layer-3 py-4 text-left md:grow-0 xl:max-w-[720px] 2xl:max-w-[780px]"
          role="dialog"
