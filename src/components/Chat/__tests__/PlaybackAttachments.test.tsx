...
vi.mock('@/src/utils/app/file', () => {
  return {
    getDialFilesFromAttachments: vi.fn().mockImplementation((attachments: Attachment[])=>{
...
describe('<PlaybackAttachments />', () => {
  ...
  const fakeData = [
    { title: 'TEST1_FILE.txt', url: "url/TEST1_FILE.txt",type: "binary/octet-stream", },
    { title: 'TEST2_FILE.txt', url: "url/TEST2_FILE.txt", type: "binary/octet-stream", },
    { title: 'TEST3_FILE.txt', url: "url/TEST3_FILE.txt", type: "binary/octet-stream", },
  ];
