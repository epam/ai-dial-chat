...
export const ConversationSettings = ({
  ...
  return (
    <div className="flex w-full flex-col gap-[1px] overflow-hidden rounded-b bg-layer-1 [&:first-child]:rounded-t">
      ...
      >
        <div className="w-[450px] max-w-full shrink overflow-auto bg-layer-2 px-3 py-4 md:px-5">
        ...
        <div
          className="flex max-h-full w-[450px] max-w-full shrink flex-col divide-y divide-tertiary overflow-auto bg-layer-2"
