...
- **THEN** each response reflects only its own resolved values. Neither response shares a mutable default array or object with the other response or with the mapping module's constants
