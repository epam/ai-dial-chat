...
- Create mode → `NotifiableEntity.Agent` + `EntityOperation.Created`.
- Edit mode → `NotifiableEntity.Agent` + `EntityOperation.Edited`.
...
- **THEN** a success notification titled `"Agent created successfully"` naming the app is shown and the host navigates to the return URL
...
- **THEN** a success notification titled `"Agent edited successfully"` naming the app is shown and the host navigates to the return URL
