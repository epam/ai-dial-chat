...
- [x] 2.1 Create `apps/chat/src/context/UserContext.tsx`. Mirror the structure of `apps/chat/src/context/ThemeContext.tsx`:
...
- [x] 2.5 Add `apps/chat/src/context/UserContext.spec.tsx` with Vitest + `@testing-library/react`. Use role/label/text queries only. Cover:
