...
#### Scenario: OverlayFeature has exactly 41 members

- **WHEN** `Object.values(OverlayFeature)` is inspected
- **THEN** it has exactly 41 unique string values, including `'chat-settings'`, `'hide-navigation-menu'`, `'voice-input'`, `'header'`, `'likes'`, `'hide-new-conversation'`, `'live-chat-interaction'`, `'prompts'`, `'skills'`, `'file-manager'`, `'hide-change-agent'`, `'hide-conversations-filter'`, and `'hide-keyboard-shortcuts'`
