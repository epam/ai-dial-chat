...
Defines validation behavior for regex pattern inputs in publication audience filters, ensuring only syntactically valid and non-empty patterns can be saved.
