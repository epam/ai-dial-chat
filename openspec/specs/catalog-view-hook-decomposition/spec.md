# catalog-view-hook-decomposition Specification

## Purpose

Decomposition of `CatalogView.tsx` into focused sub-hooks, each owning exactly one concern's state, memoized derivations, and backend calls — preserving the component's public contract, error-handling behavior, and memoization dependencies.
