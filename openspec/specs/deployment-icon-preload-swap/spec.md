# Spec: deployment-icon-preload-swap

## Purpose

Ensures `DeploymentIcon` swaps between icon sources without a visible blank frame by preloading a new `src` in the background before displaying it.
