# prompts-frontend-api Specification

## Purpose

The frontend prompt API layer: the `promptsApi` generated-client singleton in the shared registry, the `prompts.api.ts` wrappers over every generated prompt operation, error surfacing through the shared error-detail path, and the OpenAPI-generated aggregate/owner-bucket contracts.
