...
Defines how the catalog's create options (Quick App, Toolset) resolve their application schema and navigate the user into the `/apps-editor` authoring flow, including when each option is hidden.
