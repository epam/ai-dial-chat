...
- On mount, create a `VisualizerConnector` bound to the container element, passing `visualizerName: content.visualizerName` and `requestTimeout: content.requestTimeout`.
