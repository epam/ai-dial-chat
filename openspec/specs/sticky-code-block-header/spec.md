# Spec: Sticky Code Block Header

## Purpose

This capability ensures that the code block header (language label, Copy button, and Download button) remains visible at the top of the code block while the user scrolls through a long code snippet, improving accessibility and usability.
